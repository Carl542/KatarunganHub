    ...
    <div className="flex flex-col gap-6 max-w-7xl mx-auto pb-12 text-slate-800">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1 font-medium">
          Check your case status and next hearing.
        </p>
      </div>
              ...
              <div>
                ...
                {nextHearing ? (
                  <div className="mt-4 flex flex-col sm:flex-row items-start sm:items-center gap-5">
                    ...
                    <div className="w-24 h-24 border border-slate-200 rounded-lg overflow-hidden shrink-0 shadow-xs flex flex-col bg-white">
                      <div className="bg-blue-700 text-white text-xs font-bold text-center py-1 tracking-wider uppercase">
                        {monthAcronym}
                      </div>
                      <div className="flex-1 flex items-center justify-center text-3xl font-extrabold text-slate-900">
                        {dayNumber}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-2 text-sm text-slate-700">
                      <div className="flex items-center gap-2.5">
                        <Icon name="calendar" className="w-4.5 h-4.5 text-slate-500 shrink-0" />
                        <span className="font-semibold text-slate-900">{formattedFullDate}</span>
                      </div>
                      <div className="flex items-center gap-2.5">
                        <Icon name="clock" className="w-4.5 h-4.5 text-slate-500 shrink-0" />
                        <span className="font-medium text-slate-700">{formattedTime}</span>
                      </div>
                      <div className="flex items-center gap-2.5">
                        <Icon name="map-pin" className="w-4.5 h-4.5 text-slate-500 shrink-0" />
                  ...
                  <div className="p-6 bg-slate-50 rounded-lg text-xs text-slate-500 mt-4 text-center">
                    No upcoming hearing scheduled yet for this case.
                  </div>
                )}

                {/* Blue Info Notice Banner */}
                <div className="mt-6 bg-blue-50/80 border border-blue-200/80 rounded-lg p-3.5 flex items-start gap-2.5 text-xs text-blue-900 font-medium">
                  <Icon name="info" className="w-4.5 h-4.5 text-blue-600 shrink-0 mt-0.5" />
