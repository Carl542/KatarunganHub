...
import BarangayHallIllustration from "@/components/BarangayHallIllustration";
...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden flex-col justify-end p-12">
